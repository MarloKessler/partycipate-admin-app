...
export default class Admin {
    ...
    static updateUser = async user => {console.log("{ user_id: user.id, email: user.email, name: user.name }: ", { user_id: user.user_id, email: user.email, name: user.name }); await Fetch.post(`api/admin/user`, { user_id: user.user_id, email: user.email, name: user.name })}
