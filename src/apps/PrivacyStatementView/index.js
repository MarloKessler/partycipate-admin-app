...
export default function PrivacyStatementView (){
  return(
    <StandardPage className="privacy-statement-view" title="Privacy 🎉">
      ...
      <h4>Who is the responsible party for the recording of data on this website (i.e. the &bdquo;controller&ldquo;)?</h4> 
      ...
      E-mail: { process.env.REACT_APP_INFO_EMAIL_ADDRESS }</p>
