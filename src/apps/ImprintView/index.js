...
export default function ImprintView() {
  return(
    <div className="imprint-view">
      <PageTitleElement>Imprint 🎉</PageTitleElement>
    ...
    <p>Commercial Register: HRB 999999<br/>
    ...
    <p><strong>Chairman of Supervisory Board:</strong><br/>
    Bj&ouml;rn St&uuml;tz</p>
    
    <br/>
    <h2>Contact</h2>
    <p>Telephone: +49 (0) 123 44 55 66<br/>
