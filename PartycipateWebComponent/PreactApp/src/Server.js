...
export default class Server {
    ...
    static async getSurveyResults(id) {
        return { id: 123, title: "Random Question Survey", elements: [{ id: 123, type: "multiple-choice", content: { question: "How much is the fish?", answers: [ "42", "$30000", "There is nothing so big to imagine…" ], responses: [5, 4, 3] } }]}
    }
}